...
export default defineConfig({
  ...
  server: {
    headers: {
      ...
      // Note: 'unsafe-inline' in script-src is required for Vite's HMR and dev server to function correctly.
      // In production (Vercel), we use a stricter policy (see vercel.json).
