...
- [ ] 🎨 Style/UI update (visual changes, CSS, etc.)
...
- [ ] I have verified responsive design on different screen sizes

## Additional Notes

<!-- Any additional information for reviewers, deployment notes, or follow-up tasks -->
