...
async function updateData() {
  ...
  try {
    ...
    console.error('\n❌ Error:', error.message);
    // Don't log stack trace in production/CI logs if unnecessary.
    // To comply with strict "fail safe" (errors shouldn't leak system details), we only log the message.
    process.exit(1);
  }
}
