...
function AppContent() {
  ...
  return (
    <div className="min-h-screen text-slate-800 p-2 md:p-4 font-sans selection:bg-blue-100 selection:text-blue-900 overflow-hidden">
      <a
        href="#main-content"
        className="sr-only focus-visible:not-sr-only absolute top-4 left-4 z-[100] px-4 py-2 bg-blue-600 text-white font-bold rounded-lg shadow-lg focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-300 transition-transform"
      >
