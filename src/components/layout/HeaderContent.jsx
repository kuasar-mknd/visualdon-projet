      ...
      <div className="flex items-center gap-4">
          ...
          >
              <button
                  ...
                  title="English"
                  className={`px-3 py-1.5 rounded-md text-xs font-bold transition-all duration-200 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 outline-none cursor-pointer ${
                    language === 'en'
