  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="flex items-center gap-3 mb-4 flex-wrap">
        ...
        {viewMode === 'bubbles' && (
          <label className="flex items-center gap-3 px-4 py-2 bg-white rounded-lg border border-slate-200 cursor-pointer hover:bg-slate-50 transition-colors focus-within:ring-2 focus-within:ring-offset-2 focus-visible:ring-blue-500 shadow-sm">
            <input 
              type="checkbox" 
              checked={split} 
