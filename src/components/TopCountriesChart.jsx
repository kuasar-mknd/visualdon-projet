...
const TopCountriesChart = ({ data, year, category, isPlaying, onCountrySelect, displayCategory }) => {
  ...
  useEffect(() => {
    ...
    // Optimization: Batch fetch country names
    // Replaced Promise.all(map) with single batch request
    const fetchTranslations = async () => {
      const newTranslations = await fetchCountriesBatch(neededCodes, language);
