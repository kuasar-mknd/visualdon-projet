...
const YearSlider = ({ year, setYear, yearRange }) => {
  const { t } = useLanguage();
...
// We don't strictly need React.memo here because it depends on 'year' which changes frequently,
// but it's good practice for when parent re-renders for other reasons.
