...
import { geoOrthographic, geoPath, interpolateRgb, scaleSequentialLog, select, zoom, drag, zoomIdentity } from 'd3';
...
const Globe = ({ data, geoJson, category, maxVal, onCountrySelect }) => {
  ...
  useEffect(() => {
    ...
    svg.call(zoomBehavior.transform, zoomIdentity.scale(scaleRef.current / 250));
