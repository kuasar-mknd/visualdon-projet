...
- **Interactive Focus:** Consistently use `focus-visible:` utilities (like `focus-visible:ring-2`, `focus-visible:stroke-white`) instead of plain `focus:` pseudo-classes on interactive elements (buttons, links, selects, SVG paths). This provides clear focus states for keyboard users without leaving sticky "outline" styles after a mouse click.
