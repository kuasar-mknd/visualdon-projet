...
| 2026-03-25 | DocOps Refinement | README.md, docs/API.md, docs/ARCHITECTURE.md, docs/ENV.md, .github/workflows/*.yml | Added Performance/Caching to API docs, Infrastructure details to Architecture, timeout-minutes to Workflows, and verified integrity. |
