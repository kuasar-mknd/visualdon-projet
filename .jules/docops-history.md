...
| 2025-12-26 | Maintenance | README.md, docs/* | Validated workflows, updated version badges, improved architecture and env docs |
...
| 2026-03-23 | DocOps + CI | README.md, docs/*, .github/workflows/*, .env.example | Detected Frontend stack (ignoring prompt persona). Updated docs (README, ARCHITECTURE, AI, ENV, API) to match reality. Added CI, CodeQL, Dependency Review, Dependabot. Verified via pnpm. |
