...
| 2026-03-22 | DocOps Consistency | package.json, docs/API.md | Enforced Node 20+/pnpm 9+ in package.json to match CI. Updated API docs with Auth/Error Handling details. |
